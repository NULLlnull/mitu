...
$.extend($.fn.dataTable.defaults, {
	...
	language: {
		"url": "plugins/assets/lib/datatables/datatables_language.json"
	},
...
function getDTOperateBtn(btns, id, jsp, otherParam, url, fn) {
	...
	if(contains(btns, 'edit')) {
		html += '&nbsp;<a title="编辑" href="javascript:;" onclick="edit(\'编辑\',\'' + jsp + '\',' + id + ',\'850\',\'500\')" style="text-decoration:none"><i class="Hui-iconfont">&#xe6df;</i></a>&nbsp;';
	}
