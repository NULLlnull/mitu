...
<body>
                        ...
                        <div class="clearfix cl">
                           <div class="Add_p_s">
                              ...
                              <div class="formControls">
                                <input type="text" class="input-text"  name="jzldm">
                              </div>
                           </div>
                           <div class="Add_p_s">
                              <label class="form-label">教研室代码：</label>
                              <div class="formControls">
                                <input type="text" class="input-text"  name="jzlmc">
                              </div>
                           </div>
                           <div class="Add_p_s">
                           ...
                           <div class="Add_p_s">
                              <label class="form-label">是否住宿楼：</label>
                              <div class="formControls">
                                 <span class="select-box">
                                    <select class="select" name="sfzsl" style="width: 100px">
   ...
   <script type="text/javascript" src="plugins/assets/pages/jzlxx_add.js"></script>
</body>
</html>
