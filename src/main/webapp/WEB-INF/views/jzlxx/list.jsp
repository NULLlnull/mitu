...
<body>
	<nav class="breadcrumb">
      ...
      <span class="c-gray en">&gt;</span>建筑楼管理
   ...
   <div class="page-container">
      <div class="cl pd-5 mt-10">
         <c:if test="${sessionScope._cutrrent_privilege[resIdAdd]}">
            <button class="btn btn-primary" type="button" onclick="toAdd('jzlxx/toEdit.do')">
               <i class="Hui-iconfont">&#xe600;</i> 新增
            </button>
         </c:if>
         <c:if test="${sessionScope._cutrrent_privilege[resIdDel]}">
            <button class="btn btn-danger" type="button" onclick="del(getDTSelect(), '/jzlxx/del.do', reloadTable)">
   ...
   <script type="text/javascript" src="plugins/assets/pages/jzlxx_list.js"></script>
</body>
</html>
