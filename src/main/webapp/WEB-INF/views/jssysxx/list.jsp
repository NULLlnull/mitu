...
<body>
   <nav class="breadcrumb">
      <i class="Hui-iconfont">&#xe67f;</i> 基础数据
      <span class="c-gray en">&gt;</span>教室管理
   ...
   <div class="page-container">
      <div class="cl pd-5 mt-10">
         <c:if test="${sessionScope._cutrrent_privilege[resIdAdd]}">
            <button class="btn btn-primary" type="button" onclick="toAdd('jssysxx/toEdit.do')">
               <i class="Hui-iconfont">&#xe600;</i> 新增
            </button>
         </c:if>
         <c:if test="${sessionScope._cutrrent_privilege[resIdDel]}">
            <button class="btn btn-danger" type="button" onclick="del(getDTSelect(), '/jssysxx/del.do', reloadTable)">
               <i class="Hui-iconfont">&#xe609;</i> 删除
            </button>
         </c:if>
         <button class="btn btn-success" type="button" onclick="exportExecl();"><i class="Hui-iconfont">&#xe644;</i> 导出  </button>
   ...
   <script type="text/javascript" src="plugins/assets/pages/jssysxx_list.js"></script>
</body>
</html>
