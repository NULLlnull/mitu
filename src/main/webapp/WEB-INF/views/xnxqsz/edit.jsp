...
<body>
               ...
               <div class="row">
                  <div class="col-xs-12">
                     <form action="" method="post" class="form form-horizontal" id="form-article-add">
                        ...
                        <div class="clearfix cl">
                           <div class="Add_p_s">
                              ...
                              <div class="formControls">
                                <input type="text" class="input-text" name="xn">
                              </div>
                           </div>
                           <div class="Add_p_s">
                              <label class="form-label">学期：</label>
                              <div class="formControls">
                                <input type="text" class="input-text" name="xq">
                              </div>
                           </div>
                           <div class="Add_p_s">
                              <label class="form-label">开学时间：</label>
                              <div class="formControls">
                                <input type="text" class="input-text" format="yyyy-MM-dd" name="kxsj">
                              </div>
                           </div>
                           <div class="Add_p_s">
                              <label class="form-label">结束时间：</label>
                              <div class="formControls">
                                <input type="text" class="input-text" format="yyyy-MM-dd" name="jssj">
                              </div>
                           </div>
                           <div class="Add_p_s">
                              <label class="form-label">周数：</label>
                              <div class="formControls">
                                <input type="text" class="input-text" name="zs">
                              </div>
                           </div>
                        </div>
                        <div class="clearfix cl">
                           <div class="Add_p_s">
                              <label class="form-label">新生报到时间：</label>
                              <div class="formControls">
                                <input type="text" class="input-text" format="yyyy-MM-dd" name="xsbdsj">
                              </div>
                           </div>
                           <div class="Add_p_s">
                              <label class="form-label">登分开始时间：</label>
                              <div class="formControls">
                                <input type="text" class="input-text" format="yyyy-MM-dd" name="cjlrkssj">
                              </div>
                           </div>
                           <div class="Add_p_s">
                              <label class="form-label">登分结束时间：</label>
                              <div class="formControls">
                                <input type="text" class="input-text" format="yyyy-MM-dd" name="cjlrjssj">
                              </div>
                           </div>
                        </div>
                        ...
                        <div class="clearfix cl">
                           <div>
                              <label class="form-label" style="width: 250px">正常课教学日程安排开放开始时间：</label>
                              <div class="formControls">
                                <input type="text" class="input-text" format="yyyy-MM-dd" name="zckjxrcapkfkssj">
                              </div>
                           </div>
                        </div>
                        <div class="clearfix cl">
                           <div>
                              <label class="form-label" style="width: 250px">正常课教学日程安排开放结束时间：</label>
                              <div class="formControls">
                                <input type="text" class="input-text" format="yyyy-MM-dd" name="zckjxrcapkfjssj">
                              </div>
                           </div>
                        </div>
                        <div class="clearfix cl">
   ...
   <script type="text/javascript" src="plugins/assets/pages/xnxqsz_add.js"></script>
</body>
</html>
