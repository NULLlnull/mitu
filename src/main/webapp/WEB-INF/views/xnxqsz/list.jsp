...
<body>
   <nav class="breadcrumb">
      ...
      <span class="c-gray en">&gt;</span>学年学期管理
   ...
   <div class="page-container">
      <div class="cl pd-5 mt-10">
         <c:if test="${sessionScope._cutrrent_privilege[resIdAdd]}">
            <button class="btn btn-primary" type="button" onclick="toAdd('xnxqsz/toEdit.do')">
               <i class="Hui-iconfont">&#xe600;</i> 新增
            </button>
         </c:if>
         <c:if test="${sessionScope._cutrrent_privilege[resIdDel]}">
            <button class="btn btn-danger" type="button" onclick="del(getDTSelect(), '/xnxqsz/del.do', reloadTable)">
      ...
      <table class="table table-border table-bordered table-hover table-bg table-sort" width="100%">
         <thead>
            <tr class="text-c">
               ...
               <th>周数</th>
               <th>新生报到时间</th>
               <th>正常课教学日程安排开放开始时间</th>
               <th>正常课教学日程安排开放结束时间</th>
               <th>登分开始时间</th>
               <th>登分结束时间</th>
               <th>操作</th>
            </tr>
   ...
   <script type="text/javascript" src="plugins/assets/pages/xnxqsz_list.js"></script>
</body>
</html>
