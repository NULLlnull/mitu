...
<body>
                  ...
                  <div class="col-sm-12">
                     <div id="calendar" class="fc fc-ltr">
                        ...
                        <div class="fc-view fc-view-month fc-grid" style="position: relative" unselectable="on">
                           <table class="fc-border-separate" style="width: 100%" cellspacing="0" id="data">
                              <thead>
                                 <tr class="fc-first fc-last">
                                    <th class="fc-day-header fc-sun fc-widget-header fc-first"></th>
                                    <th class="fc-day-header fc-sun fc-widget-header"></th>
                                    <th class="fc-day-header fc-mon fc-widget-header">星期一</th>
                                    <th class="fc-day-header fc-mon fc-widget-header">星期二</th>
                                    <th class="fc-day-header fc-tue fc-widget-header">星期三</th>
                                    <th class="fc-day-header fc-wed fc-widget-header">星期四</th>
                                    <th class="fc-day-header fc-thu fc-widget-header">星期五</th>
                                    <th class="fc-day-header fc-fri fc-widget-header">星期六</th>
                                    <th class="fc-day-header fc-sat fc-widget-header">星期日</th>
                                 </tr>
                              </thead>
                              <tbody>
                              </tbody>
   ...
   <script type="text/javascript" src="plugins/assets/pages/pkxx.js"></script>
   <!-- 筛选渲染 -->
</body>
</html>
