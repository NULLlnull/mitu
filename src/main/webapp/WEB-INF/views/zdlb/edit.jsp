...
<body>
                  ...
                  <div class="col-xs-12">
                     <form action="" method="post" class="form form-horizontal" id="form-article-add">
                        ...
                        <div class="clearfix cl">
                           <div class="Add_p_s">
                              <label class="form-label">字典类别代码：</label>
                              <div class="formControls">
                                <input type="text" class="input-text" name="lbdm">
                              </div>
                           </div>
                           <div class="Add_p_s">
                              <label class="form-label">字典类别名称：</label>
                              <div class="formControls">
                                <input type="text" class="input-text" name="lbmc">
                              </div>
                           </div>
                        </div>
                        <div class="clearfix cl">
   ...
   <script type="text/javascript" src="plugins/assets/pages/zdlb_add.js"></script>
</body>
</html>
