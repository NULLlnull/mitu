...
<body>
   <nav class="breadcrumb">
      ...
      <span class="c-gray en">&gt;</span>教研室管理
   ...
   <div class="page-container">
      <div class="cl pd-5 mt-10">
         <c:if test="${sessionScope._cutrrent_privilege[resIdAdd]}">
            <button class="btn btn-primary" type="button" onclick="toAdd('jysxx/toEdit.do')">
               <i class="Hui-iconfont">&#xe600;</i> 新增
            </button>
         </c:if>
         <c:if test="${sessionScope._cutrrent_privilege[resIdDel]}">
            <button class="btn btn-danger" type="button" onclick="del(getDTSelect(), '/jysxx/del.do', reloadTable)">
   ...
   <script type="text/javascript" src="plugins/assets/pages/jysxx_list.js"></script>
</body>
</html>
