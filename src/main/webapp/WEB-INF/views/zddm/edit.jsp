...
<body>
                  ...
                  <div class="col-xs-12">
                     <form action="" method="post" class="form form-horizontal" id="form-article-add">
                        ...
                        <div class="clearfix cl">
                           <div class="Add_p_s">
                              <label class="form-label">所属字典类别：</label>
                              <div class="formControls">
                                <input type="text" class="input-text" name="sszdlb">
                              </div>
                           </div>
                           <div class="Add_p_s">
                              <label class="form-label">字典代码名称：</label>
                              <div class="formControls">
                                <input type="text" class="input-text" name="dmmc">
                              </div>
                           </div>
                           <div class="Add_p_s">
                              <label class="form-label">字典代码：</label>
                              <div class="formControls">
                                 <input type="text" class="input-text" name="dmbh">
                              </div>
                           </div>
                        </div>
                        <div class="clearfix cl">
   ...
   <script type="text/javascript" src="plugins/assets/pages/zddm_add.js"></script>
</body>
</html>
